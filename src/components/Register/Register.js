...
class RegisterIn extends React.Component {
    ...
    onSubmitSignIn = (event) => {
        ...
        fetch('https://warm-woodland-88091.herokuapp.com/register', {
            method: 'post',
    ...
    render() {
        return(
            <article className="br3 ba white b--white mv4 w-100 w-50-m w-25-l mw5 shadow-5 center">
            <main className="pa4 white">
                <div className="measure">
                    ...
                    <div className="mt3">
                        <label className="db fw6 white lh-copy f6" htmlFor="email-address">Name</label>
                        <input 
